...
public class ShopManagerUI : MonoBehaviour
{
    ...
    public void ShowPlayerStats()
    {
        ...
        LeanTween.move(playerStatsPanel, playerStatsOpenedPos, 0.5f).setEase(LeanTweenType.easeInCubic);
    ...
    public void ShowInventory()
    {
        ...
        LeanTween.move(inventoryPanel, inventoryOpenedPos, 0.5f).setEase(LeanTweenType.easeInCubic);
    ...
    public void HideInventory(bool hideItemInfo = true)
    {
        ...
        LeanTween.cancel(inventoryPanel);
        LeanTween.move(inventoryPanel, inventoryClosedPos, 0.5f)
            .setEase(LeanTweenType.easeOutCubic)
    ...
    public void ShowItemInfo()
    {
        ...
        itemInfoSlidePanel.LeanMove((Vector3)itemInfoOpenedPos, 0.3f).setEase(LeanTweenType.easeOutCubic);
    }
    ...
    {
        itemInfoSlidePanel.LeanCancel();
        itemInfoSlidePanel.LeanMove((Vector3)itemInfoClosedPos, 0.3f)
